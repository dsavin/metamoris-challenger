...
class EditUserVoter implements VoterInterface
{
    ...
    public function vote(TokenInterface $token, $object, array $attributes)
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            if ($attribute == 'EDIT_USER') {
                ...
                return $this->usersHaveSameId($user,
                    $user2) ? VoterInterface::ACCESS_GRANTED : VoterInterface::ACCESS_DENIED;
            }

            if ($attribute == 'EDIT_USER_ID') {
                $id = $object;

                return $this->hasUserId($user,
                    $id) ? VoterInterface::ACCESS_GRANTED : VoterInterface::ACCESS_DENIED;
            }
        }
    ...
    {
        return VoterInterface::ACCESS_GRANTED == $this->roleHierarchyVoter->vote($token,
            null, array($role));
    }
